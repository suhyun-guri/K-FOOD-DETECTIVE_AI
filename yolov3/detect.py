...
def run(weights=ROOT / 'yolov3.pt',  # model.pt path(s)
    ...
    #받은 base64 string 이미지 픽셀 배열로 디코딩
    ...
    # output_dic = {'image' : base64.b64encode(im0), 'bbox' : bbox_list, 'class' : class_list}
    output_dic = {'image' : im0, 'bbox' : bbox_list, 'class' : class_list}
    return output_dic
